...
(0046)  CS-0x01E  0x0833A         || 		BREQ RETURN
(0047)                            || 		
...
(0059)  CS-0x029  0x0833A         || 			BREQ RETURN     ; ifR15 greater than max
...
(0069)  CS-0x02E  0x0833A         || 			BREQ RETURN
...
(0080)  CS-0x033  0x0833A         || 			BREQ RETURN
...
(0097)  CS-0x03E  0x08280         || 			BRN STORERECORDINGHOLD
(0098)                            || 
(0099)                            || 		
(0100)  CS-0x03F  0x04F80  0x03F  || PLAYRECORDING: 	CMP R15,R16
(0101)  CS-0x040  0x0833A         || 				BREQ RETURN
...
(0105)  CS-0x044  0x35A90         || 				OUT R26,SPEAKER
(0106)  CS-0x045  0x29001         || 				ADD R16,0x01
(0107)  CS-0x046  0x31930         || 				CMP R25,0x30
(0108)  CS-0x047  0x080FA         || 				BREQ PLAYQUART
(0109)  CS-0x048  0x31960         || 				CMP R25,0x60
(0110)  CS-0x049  0x08112         || 				BREQ PLAYHALF
(0111)  CS-0x04A  0x319BF         || 				CMP R25,0xBF
(0112)  CS-0x04B  0x0812A         || 				BREQ PLAYFULL
(0113)  CS-0x04C  0x04F80         || 				CMP R15,R16
(0114)  CS-0x04D  0x081FB         || 				BRNE PLAYRECORDING
(0115)  CS-0x04E  0x35F90         || 				OUT R31,SPEAKER
(0116)  CS-0x04F  0x08338         || 				BRN 	RETURN
(0117)                            || 			   
(0118)                            || 			   
(0119)                     0x050  || STORERECORDINGHOLD: 
(0120)                            || 		;IN 	R9, KEYBOARD
(0121)  CS-0x050  0x32744         || 		IN	R7,	KEYBOARD
(0122)  CS-0x051  0x30705         || 		CMP R7,	0X05
(0123)  CS-0x052  0x08142         || 		BREQ	SET_QUART
(0124)  CS-0x053  0x30706         || 		CMP R7,	0X06
(0125)  CS-0x054  0x0816A         || 		BREQ	SET_HALF
(0126)  CS-0x055  0x30704         || 		CMP R7,	0X04
(0127)  CS-0x056  0x08192         || 		BREQ	SET_FULL
(0128)  CS-0x057  0x30709         || 		CMP R7, 0X09
(0129)  CS-0x058  0x08342         || 		BREQ 	RETURNFROMSHOPPING	;STOP RECORDING BEFORE PLAYING 
(0130)  CS-0x059  0x08280         || 	    BRN STORERECORDINGHOLD
(0131)                            || 
(0132)                     0x05A  || OVERWRITE:
(0133)  CS-0x05A  0x36F00         || 		MOV R15,0x00
(0134)  CS-0x05B  0x37000         || 		MOV R16,0x00
(0135)  CS-0x05C  0x08338         || 		BRN RETURN
(0136)  CS-0x05D  0x32644  0x05D  || BLOOD:	IN R6, 	KEYBOARD	;RECORD ENABLE
(0137)  CS-0x05E  0x30600         || 		CMP R6,	0X00
(0138)  CS-0x05F  0x0833A         || 		BREQ	RETURN
(0139)  CS-0x060  0x30678         || 		CMP R6,	0X78
(0140)  CS-0x061  0x08282         || 		BREQ	STORERECORDINGHOLD
(0141)  CS-0x062  0x30607         || 		CMP R6, 0X07
(0142)  CS-0x063  0x081FA         || 		BREQ	PLAYRECORDING
(0143)  CS-0x064  0x30666         || 		CMP R6, 0x66
(0144)  CS-0x065  0x082D2         || 		BREQ OVERWRITE
(0145)  CS-0x066  0x34690         || 		OUT	R6, SPEAKER
(0146)                            || 	
(0147)  CS-0x067  0x1A003  0x067  || RETURN:	RETIE
(0148)                            || 
(0149)  CS-0x068  0x36600  0x068  || RETURNFROMSHOPPING:	MOV R6,0X00
(0150)  CS-0x069  0x1A003         || 					RETIE
(0151)                            || 
(0152)                            || 
(0153)                       1023  || .ORG 0X3FF
(0154)  CS-0x3FF  0x082E8  0x3FF  || ISR: 	BRN BLOOD
NG:	MOV R6,0X00
(0155)  CS-0x400  0x36600  0x400  || ISR: 	BRN BLOOD
NG:	MOV R6,0X00
...
NG             0x400   (0155)  ||  
OVERWRITE      0x05A   (0132)  ||  0144 
PLAYFULL       0x025   (0054)  ||  0112 
PLAYHALF       0x022   (0051)  ||  0110 
PLAYQUART      0x01F   (0048)  ||  0108 
PLAYRECORDING  0x03F   (0100)  ||  0045 0114 0142 
RETURN         0x067   (0147)  ||  0046 0059 0069 0080 0101 0116 0135 0138 
RETURNFROMSHOPPING 0x068   (0149)  ||  0129 
SET_FULL       0x032   (0079)  ||  0127 
SET_HALF       0x02D   (0068)  ||  0125 
SET_QUART      0x028   (0058)  ||  0123 
STORENOTE      0x037   (0090)  ||  0063 0072 0083 0092 0094 
STORERECORDINGHOLD 0x050   (0119)  ||  0097 0130 0140 
...
-- Directives: .EQU
------------------------------------------------------------ 
KEYBOARD       0x044   (0003)  ||  0090 0121 0136 
LEDS           0x040   (0004)  ||  
SPEAKER        0x090   (0005)  ||  0026 0049 0052 0055 0105 0115 0145 
