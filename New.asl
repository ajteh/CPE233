...
(0022)  CS-0x00E  0x30600  0x00E  || MAIN: 	CMP R6, 0x00        ;The main allows regular notes to be played and ensures that the last note of the recording isn't held to infinity  
...
(0047)  CS-0x01F  0x08342         || 		BREQ RETURN
(0048)                            || 		
...
(0060)  CS-0x02A  0x08342         || 			BREQ RETURN     ; ifR15 greater than max
...
(0070)  CS-0x02F  0x08342         || 			BREQ RETURN
...
(0081)  CS-0x034  0x08342         || 			BREQ RETURN
...
(0102)  CS-0x041  0x08342         || 				BREQ RETURN        ; if that happens go back to main and keep running
...
(0121)                            || 		;IN 	R9, KEYBOARD
(0122)  CS-0x04F  0x36F00         || 		MOV R15,0X00
(0123)  CS-0x050  0x37000         || 		MOV R16,0X00
(0124)  CS-0x051  0x32744         || 		IN	R7,	KEYBOARD         ; there are two inputs needed for storing recording, specifically here for taking in the hold time
(0125)  CS-0x052  0x30705         || 		CMP R7,	0X05			; compare the hold time input to F1, if it is then it is a quarternote
(0126)  CS-0x053  0x0814A         || 		BREQ	SET_QUART
(0127)  CS-0x054  0x30706         || 		CMP R7,	0X06             ; compare the hold time input to F2, if it is then it should be stored as a half note
(0128)  CS-0x055  0x08172         || 		BREQ	SET_HALF
(0129)  CS-0x056  0x30704         || 		CMP R7,	0X04              ; compare the hold time input to F3, if it is then it should be stored as a full note
(0130)  CS-0x057  0x0819A         || 		BREQ	SET_FULL 
(0131)  CS-0x058  0x30709         || 		CMP R7, 0X09             ; if the button pressed isn't a hold button but F10, then that means user wants to stop recording 
(0132)  CS-0x059  0x0834A         || 		BREQ 	RETURNFROMRECORDING	;STOP RECORDING BEFORE PLAYING 
(0133)  CS-0x05A  0x08278         || 	    BRN STORERECORDINGHOLD          ; if no input keep looking for one after seeing that user wants to record 
(0134)                            || 
(0135)                     0x05B  || OVERWRITE:							; overwrite SCR allowing the delete recording to occur
(0136)  CS-0x05B  0x36F00         || 		MOV R15,0x00				; if backspace is hit then that means the SCR counters should go back to 0
(0137)  CS-0x05C  0x37000         || 		MOV R16,0x00
(0138)  CS-0x05D  0x08340         || 		BRN RETURN                 
(0139)                            || 
(0140)  CS-0x05E  0x32644  0x05E  || INTERRUPT:	IN R6, 	KEYBOARD	;Sets R6 to whatever comes in in the input from the interrupt 
(0141)  CS-0x05F  0x30600         || 		CMP R6,	0X00
(0142)  CS-0x060  0x08342         || 		BREQ	RETURN
(0143)  CS-0x061  0x30678         || 		CMP R6,	0X78            ; if the input value is F11 start recording
(0144)  CS-0x062  0x0827A         || 		BREQ	STORERECORDINGHOLD
(0145)  CS-0x063  0x30607         || 		CMP R6, 0X07			; if the input value is F12 play the recording
(0146)  CS-0x064  0x08202         || 		BREQ	PLAYRECORDING
(0147)  CS-0x065  0x30666         || 		CMP R6, 0x66
(0148)  CS-0x066  0x082DA         || 		BREQ OVERWRITE            ; if backspace is hit then delete recording
(0149)  CS-0x067  0x34690         || 		OUT	R6, SPEAKER				; else this means a normal key is pressed so out to speaker
(0150)                            || 	
(0151)  CS-0x068  0x1A003  0x068  || RETURN:	RETIE					; allow to return back to main enabling the interrupts
(0152)                            || 
(0153)  CS-0x069  0x36600  0x069  || RETURNFROMRECORDING: 	MOV R6,0X00
(0154)  CS-0x06A  0x35F90         || 						OUT R31, SPEAKER
(0155)  CS-0x06B  0x1A003         || 						RETIE
(0156)                            || ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(0157)                            || 
(0158)                       1023  || .ORG 0X3FF
(0159)  CS-0x3FF  0x082F0  0x3FF  || ISR: 	BRN INTERRUPT
...
-- Labels
------------------------------------------------------------ 
INTERRUPT      0x05E   (0140)  ||  0159 
ISR            0x3FF   (0159)  ||  
LOOP1          0x014   (0030)  ||  0041 0051 0054 0057 
LOOP2          0x015   (0031)  ||  0038 
LOOP3          0x016   (0034)  ||  0035 
MAIN           0x00E   (0022)  ||  0023 0025 0027 
OVERWRITE      0x05B   (0135)  ||  0148 
PLAYFULL       0x026   (0055)  ||  0113 
PLAYHALF       0x023   (0052)  ||  0111 
PLAYQUART      0x020   (0049)  ||  0109 
PLAYRECORDING  0x040   (0101)  ||  0045 0115 0146 
RETURN         0x068   (0151)  ||  0047 0060 0070 0081 0102 0138 0142 
RETURNFROMRECORDING 0x069   (0153)  ||  0132 
SET_FULL       0x033   (0080)  ||  0130 
SET_HALF       0x02E   (0069)  ||  0128 
SET_QUART      0x029   (0059)  ||  0126 
STORENOTE      0x038   (0091)  ||  0064 0073 0084 0093 0095 
STORERECORDINGHOLD 0x04F   (0120)  ||  0098 0133 0144 
...
-- Directives: .EQU
------------------------------------------------------------ 
KEYBOARD       0x044   (0003)  ||  0091 0124 0140 
LEDS           0x040   (0004)  ||  
SPEAKER        0x090   (0005)  ||  0026 0050 0053 0056 0106 0149 0154 
