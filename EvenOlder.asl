...
(0046)  CS-0x01E  0x08312         || 		BREQ RETURN
(0047)                            || 		
...
(0059)  CS-0x029  0x08312         || 			BREQ RETURN     ; ifR15 greater than max
...
(0069)  CS-0x02E  0x08312         || 			BREQ RETURN
...
(0080)  CS-0x033  0x08312         || 			BREQ RETURN
...
(0097)  CS-0x03E  0x08268         || 			BRN STORERECORDINGHOLD
(0098)                            || 
(0099)                            || 		
...
(0113)  CS-0x04B  0x35F90         || 			   OUT R31,SPEAKER
(0114)  CS-0x04C  0x08310         || 			   BRN 	RETURN
(0115)                            || 			   
(0116)                            || 			   
(0117)                     0x04D  || STORERECORDINGHOLD: 
(0118)                            || 		;IN 	R9, KEYBOARD
(0119)  CS-0x04D  0x32744         || 		IN	R7,	KEYBOARD
(0120)  CS-0x04E  0x30705         || 		CMP R7,	0X05
(0121)  CS-0x04F  0x08142         || 		BREQ	SET_QUART
(0122)  CS-0x050  0x30706         || 		CMP R7,	0X06
(0123)  CS-0x051  0x0816A         || 		BREQ	SET_HALF
(0124)  CS-0x052  0x30704         || 		CMP R7,	0X04
(0125)  CS-0x053  0x08192         || 		BREQ	SET_FULL
(0126)  CS-0x054  0x30709         || 		CMP R7, 0X09
(0127)  CS-0x055  0x0831A         || 		BREQ 	RETURNFROMSHOPPING	;STOP RECORDING BEFORE PLAYING 
(0128)  CS-0x056  0x08268         || 	    BRN STORERECORDINGHOLD
(0129)                            || 
(0130)                     0x057  || OVERWRITE:
(0131)  CS-0x057  0x36F00         || 		MOV R15,0x00
(0132)  CS-0x058  0x37000         || 		MOV R16,0x00
(0133)  CS-0x059  0x08310         || 		BRN RETURN
(0134)  CS-0x05A  0x32644  0x05A  || BLOOD:	IN R6, 	KEYBOARD	;RECORD ENABLE
(0135)                            || 		;CMP R6,	0X00
(0136)                            || 		;BREQ	RETURN
(0137)  CS-0x05B  0x30678         || 		CMP R6,	0X78
(0138)  CS-0x05C  0x0826A         || 		BREQ	STORERECORDINGHOLD
(0139)  CS-0x05D  0x30607         || 		CMP R6, 0X07
(0140)  CS-0x05E  0x081FA         || 		BREQ	PLAYRECORDING
(0141)  CS-0x05F  0x30666         || 		CMP R6, 0x66
(0142)  CS-0x060  0x082BA         || 		BREQ OVERWRITE
(0143)  CS-0x061  0x34690         || 		OUT	R6, SPEAKER
(0144)                            || 	
(0145)  CS-0x062  0x1A003  0x062  || RETURN:	RETIE
(0146)                            || 
(0147)  CS-0x063  0x36600  0x063  || RETURNFROMSHOPPING:	MOV R6,0X00
(0148)  CS-0x064  0x1A003         || 					RETIE
(0149)                            || 
(0150)                            || 
(0151)                       1023  || .ORG 0X3FF
(0152)  CS-0x3FF  0x082D0  0x3FF  || ISR: 	BRN BLOOD
...
-- Labels
------------------------------------------------------------ 
BLOOD          0x05A   (0134)  ||  0152 
ISR            0x3FF   (0152)  ||  
LOOP1          0x014   (0030)  ||  0041 0050 0053 0056 
LOOP2          0x015   (0031)  ||  0038 
LOOP3          0x016   (0034)  ||  0035 
MAIN           0x00E   (0022)  ||  0023 0025 0027 
OVERWRITE      0x057   (0130)  ||  0142 
PLAYFULL       0x025   (0054)  ||  0110 
PLAYHALF       0x022   (0051)  ||  0108 
PLAYQUART      0x01F   (0048)  ||  0106 
PLAYRECORDING  0x03F   (0100)  ||  0045 0112 0140 
RETURN         0x062   (0145)  ||  0046 0059 0069 0080 0114 0133 
RETURNFROMSHOPPING 0x063   (0147)  ||  0127 
SET_FULL       0x032   (0079)  ||  0125 
SET_HALF       0x02D   (0068)  ||  0123 
SET_QUART      0x028   (0058)  ||  0121 
STORENOTE      0x037   (0090)  ||  0063 0072 0083 0092 0094 
STORERECORDINGHOLD 0x04D   (0117)  ||  0097 0128 0138 
...
-- Directives: .EQU
------------------------------------------------------------ 
KEYBOARD       0x044   (0003)  ||  0090 0119 0134 
LEDS           0x040   (0004)  ||  
SPEAKER        0x090   (0005)  ||  0026 0049 0052 0055 0113 0143 
